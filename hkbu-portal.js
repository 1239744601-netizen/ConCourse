(() => {
  ...
  const COPY = {
    en:{
      ...
      description:"Complete student-status verification first. ConCourse then shows the semester course information available for your institution.",
      supportedDescription:"Browse the shared reference catalogue for {school}. A private academic import is optional and is used only to identify courses assigned to you and estimate requirement matches.",
      unsupportedDescription:"Your verified institution is {school}. A semester catalogue source is not configured for this institution yet.",
      ...
      neverCredentials:"ConCourse never asks for your institution password, multifactor-authentication response, recovery code, or portal cookies.",
      ...
      plannerDescription:"Search the shared reference catalogue. A private academic import is optional and adds assigned-course and possible requirement guidance.",
      ...
      catalogueDisclaimer:"Reference snapshot only. Confirm live availability, eligibility, quota, and registration in the institution’s official system.",
      ...
      personalDescription:"Import a sanitized academic snapshot only if you want ConCourse to mark courses assigned to you and estimate which offerings may match remaining requirements.",
      noSnapshot:"No personal academic snapshot has been imported. This optional step is not required to browse the semester catalogue.",
      ...
      noSearchMatches:"No personalized course match was found. Check the institution’s official system for restrictions or unscheduled courses.",
    ...
    "zh-CN":{
      ...
      description:"请先完成在读身份验证。审核通过后，ConCourse 会显示适用于你所在院校的学期课程资料。",
      supportedDescription:"浏览 {school} 的共享参考课程目录。私人学业导入属于可选功能，只用于识别已分配给你的课程及估算可能符合毕业要求的课程。",
      unsupportedDescription:"你的已验证院校是 {school}。该院校暂未配置学期课程资料源。",
      ...
      neverCredentials:"ConCourse 不会索取你的院校密码、多重身份验证回复、恢复码或门户 Cookie。", privacyTitle:"会传输哪些信息？",
      privacyItems:["浏览共享学期课程目录不需要访问你的个人学生门户。","可选私人导入：课程、主修、年级、已分配课程、已完成课程代码及剩余要求。","不会传输：密码、多重身份验证内容、Cookie、原始网页、成绩、学号、法定姓名及财务记录。"],
      plannerKicker:"学期课程目录", plannerTitle:"学期参考课程目录", plannerDescription:"搜索共享参考课程目录。私人学业导入属于可选功能，可补充已分配课程及可能符合要求的课程提示。",
      ...
      catalogueDisclaimer:"此为参考快照。请在院校官方系统确认实时开课情况、资格、名额及注册结果。", catalogueNoRestriction:"请向院校确认资格及限制。",
      personalKicker:"可选个人提示", personalTitle:"已分配课程及可能符合要求的课程", personalDescription:"只有在你希望 ConCourse 标记已分配课程，并估算哪些开设课程可能符合剩余要求时，才需要导入已清理的学业快照。",
      noSnapshot:"尚未导入个人学业快照。浏览学期课程目录不需要完成此可选步骤。", assigned:"已分配给你", possible:"可能符合要求", unresolved:"需要确认", captured:"获取时间", catalogueAsOf:"课程目录截至",
      courseSearch:"搜索我的可能课程", courseSearchPlaceholder:"课程编号或名称", noSearchMatches:"没有找到个性化课程匹配，请在院校官方系统检查限制或未排课课程。", selectedCount:"已选择 {count} 门课程加入课表",
    ...
    "zh-HK":{
      ...
      description:"請先完成在讀身份驗證。審核通過後，ConCourse 會顯示適用於你所屬院校嘅學期課程資料。",
      supportedDescription:"瀏覽 {school} 嘅共享參考課程目錄。私人學業匯入係可選功能，只會用嚟識別已編配畀你嘅課程，同估算可能符合畢業要求嘅課程。",
      unsupportedDescription:"你嘅已驗證院校係 {school}。呢間院校暫時未配置學期課程資料來源。",
      ...
      neverCredentials:"ConCourse 唔會索取你嘅院校密碼、多重身份驗證回應、復原碼或平台 Cookie。", privacyTitle:"會傳送咩資料？",
      privacyItems:["瀏覽共享學期課程目錄唔需要存取你嘅個人學生平台。","可選私人匯入：課程、主修、年級、已編配課程、已完成課程代碼同剩餘要求。","唔會傳送：密碼、多重身份驗證內容、Cookie、原始網頁、成績、學號、法定姓名同財務紀錄。"],
      plannerKicker:"學期課程目錄", plannerTitle:"學期參考課程目錄", plannerDescription:"搜尋共享參考課程目錄。私人學業匯入係可選功能，可以補充已編配課程同可能符合要求嘅課程提示。",
      ...
      catalogueDisclaimer:"呢個係參考快照。請喺院校官方系統確認即時開課情況、資格、名額同註冊結果。", catalogueNoRestriction:"請向院校確認資格同限制。",
      personalKicker:"可選個人提示", personalTitle:"已編配課程同可能符合要求嘅課程", personalDescription:"只有當你想 ConCourse 標示已編配課程，並估算邊啲開設課程可能符合剩餘要求，先需要匯入已清理嘅學業快照。",
      noSnapshot:"尚未匯入個人學業快照。瀏覽學期課程目錄唔需要完成呢個可選步驟。", assigned:"已編配畀你", possible:"可能符合要求", unresolved:"需要確認", captured:"擷取時間", catalogueAsOf:"課程目錄截至",
      courseSearch:"搜尋我嘅可能課程", courseSearchPlaceholder:"課程編號或名稱", noSearchMatches:"搵唔到個人化課程配對，請喺院校官方系統檢查限制或未編排時間嘅課程。", selectedCount:"已選擇 {count} 科加入時間表",
