-- ConCourse Supabase setup — Part 2 of 2
-- Run this file only after supabase-setup-part-1.sql finishes successfully.
-- Paste it into a fresh Supabase SQL Editor query, then select Run.
