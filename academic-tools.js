(() => {
  ...
  const COPY = Object.freeze({
    en: Object.freeze({
      ...
      toolsWorkspaceIntro:"Build references, check in-text citations, and keep a project bibliography.",
      toolsLocalNote:"Your bibliography syncs to your account when available and is backed up on this device. Search metadata comes from Crossref.",
      ...
      citationAutomaticModeHint:"Paste a URL or search by title, author, DOI, or ISBN.",
      citationManualMode:"Enter manually",
      citationManualModeHint:"Enter the source details yourself.",
      ...
      citationLookupNote:"URLs are checked directly; keyword results come from Crossref. Review imported fields.",
      ...
      citationSearchReview:"Check the title, author, date, and URL.",
      ...
      citationAuthorsHint:"Separate authors with semicolons; use “Family, Given”.",
      citationTitle:"Title",
      ...
      bibliographyIntro:"Synced when available, stored on this device, and reformatted with your selected style.",
      ...
      styleApaUse:"Social sciences and business.",
      styleMlaUse:"Literature, languages, arts, and humanities.",
      styleChicagoUse:"History and publishing.",
      styleHarvardUse:"Common across disciplines; local rules vary.",
      styleIeeeUse:"Engineering and computing.",
      styleApaAdvice:"APA 7 · Check sentence case and italics.",
      styleMlaAdvice:"MLA 9 · Check title case and container details.",
      styleChicagoAdvice:"Chicago 17 · Follow your instructor’s required edition.",
      styleHarvardAdvice:"Harvard · Check your institution’s local variation.",
      styleIeeeAdvice:"IEEE · References follow the order added.",
      citationDisclaimer:"Check the result against your course or institution guide.",
      citationFormattingNote:"The generator keeps the title you enter.",
      citationStyleEngine:"Formats included: APA 7, MLA 9, Chicago 17, Harvard author-date and IEEE."
    }),
    "zh-CN": Object.freeze({
      toolsWorkspaceTitle:"引用工作室",
      toolsWorkspaceIntro:"创建参考文献、核对文内引用，并整理项目参考书目。",
      toolsLocalNote:"参考书目会在可用时同步，并保存在此设备；搜索数据来自 Crossref。",
      ...
      citationAutomaticModeHint:"粘贴网址，或按标题、作者、DOI 或 ISBN 搜索。",
      citationManualMode:"手动输入",
      citationManualModeHint:"自行填写来源资料。",
      ...
      citationLookupNote:"网址会直接核对；关键词结果来自 Crossref。请检查导入字段。",
      ...
      citationSearchReview:"选择前请核对标题、作者、日期和网址。",
      ...
      citationAuthorsPlaceholder:"Ng, Ada; Patel, Ravi",
      citationAuthorsHint:"多位作者用分号分隔；采用“姓, 名”格式。",
      citationTitle:"标题",
      ...
      bibliographyIntro:"在可用时同步，并保存在此设备；切换格式时自动排版。",
      ...
      styleApaUse:"社会科学与商科。",
      styleMlaUse:"文学、语言、艺术与人文学科。",
      styleChicagoUse:"历史与出版。",
      styleHarvardUse:"适用于多种学科；各校规则不同。",
      styleIeeeUse:"工程与计算机。",
      styleApaAdvice:"APA 第 7 版 · 检查句式大小写与斜体。",
      styleMlaAdvice:"MLA 第 9 版 · 检查标题大小写与容器信息。",
      styleChicagoAdvice:"Chicago 第 17 版 · 请遵循导师指定版本。",
      styleHarvardAdvice:"Harvard · 请核对本校规则。",
      styleIeeeAdvice:"IEEE · 参考文献按加入顺序排列。",
      citationDisclaimer:"请按课程或院校指南核对结果。",
      citationFormattingNote:"生成器会保留你输入的标题。",
      citationStyleEngine:"支持 APA 7、MLA 9、Chicago 17、Harvard 作者—日期及 IEEE。"
    }),
    "zh-HK": Object.freeze({
      toolsWorkspaceTitle:"引用工作室",
      toolsWorkspaceIntro:"建立參考文獻、核對文內引用，並整理項目參考書目。",
      toolsLocalNote:"參考書目會喺可用時同步，並保留喺呢部裝置；搜尋資料來自 Crossref。",
      citationStyleLegend:"引用格式",
      ...
      citationAutomaticModeHint:"貼上網址，或者按標題、作者、DOI 或 ISBN 搜尋。",
      citationManualMode:"手動輸入",
      citationManualModeHint:"自行填寫來源資料。",
      ...
      citationLookupNote:"網址會直接核對；關鍵字結果來自 Crossref。請檢查匯入欄位。",
      ...
      citationSearchReview:"揀選之前請核對標題、作者、日期同網址。",
      ...
      citationAuthorsPlaceholder:"Ng, Ada; Patel, Ravi",
      citationAuthorsHint:"多位作者用分號分隔；採用「姓, 名」格式。",
      citationTitle:"標題",
      ...
      bibliographyIntro:"可用時會同步，並保留喺呢部裝置；轉換格式時自動排版。",
      ...
      styleApaUse:"社會科學同商科。",
      styleMlaUse:"文學、語言、藝術同人文學科。",
      styleChicagoUse:"歷史同出版。",
      styleHarvardUse:"適用於多種學科；各校規則唔同。",
      styleIeeeUse:"工程同電腦。",
      styleApaAdvice:"APA 第 7 版 · 檢查句式大小寫同斜體。",
      styleMlaAdvice:"MLA 第 9 版 · 檢查標題大小寫同容器資料。",
      styleChicagoAdvice:"Chicago 第 17 版 · 請跟從導師指定版本。",
      styleHarvardAdvice:"Harvard · 請核對院校規則。",
      styleIeeeAdvice:"IEEE · 參考文獻按加入次序排列。",
      citationDisclaimer:"請按課程或院校指南核對結果。",
      citationFormattingNote:"產生器會保留你輸入嘅標題。",
  ...
  const ACADEMIC_COPY_REFINEMENTS = Object.freeze({
    en: Object.freeze({
      ...
      citationAutomaticModeHint:"Paste a URL or search by title, author, DOI, or ISBN.",
      citationManualModeHint:"Enter the source details.",
      citationLookupNote:"Keyword search uses Crossref. Review imported fields.",
      citationAuthorsHint:"Separate authors with semicolons; use “Family, Given”.",
      citationPreviewEyebrow:"Preview",
      citationPreviewTitle:"Reference",
      citationReferenceLabel:"Reference",
      citationPreviewPlaceholder:"Enter a title or paste a reference.",
      citationInlinePlaceholder:"The in-text citation appears here.",
      citationEditHint:"Edit the generated entry here.",
      citationCopy:"Copy",
      citationAdd:"Save to bibliography",
      bibliographyTitle:"Bibliography",
      bibliographyIntro:"Synced to your account when available; backed up on this device.",
      styleCompassTitle:"Style guide",
      styleApaUse:"Social sciences, education, and business.",
      styleMlaUse:"Literature, languages, and the arts.",
      styleChicagoUse:"History and publishing.",
      styleHarvardUse:"Used across disciplines; local rules vary.",
      styleIeeeUse:"Engineering and computing.",
      styleApaAdvice:"APA 7 · Check sentence case and italics.",
      styleMlaAdvice:"MLA 9 · Check title case.",
      styleChicagoAdvice:"Chicago 17 · Follow the edition your course requires.",
      styleHarvardAdvice:"Harvard · Author–date rules vary by university.",
      styleIeeeAdvice:"IEEE · References follow the order added.",
      citationDisclaimer:"Check every citation against your course or publication guide.",
      citationFormattingNote:""
    }),
    "zh-CN": Object.freeze({
      ...
      citationLookupNote:"关键词搜索使用 Crossref。请核对导入字段。",
      ...
      citationAuthorsHint:"多位作者用分号分隔；建议使用“姓, 名”。",
      ...
      citationPreviewEyebrow:"预览",
      citationPreviewTitle:"参考文献",
      citationReferenceLabel:"参考文献",
      citationNoteLabel:"简式脚注",
      citationPreviewPlaceholder:"输入标题或粘贴参考文献。",
      citationCopy:"复制",
      ...
      citationInlinePlaceholder:"文内引用会显示在这里。",
      citationEditHint:"可在这里修改生成结果。",
      citationAdd:"保存到参考书目",
      bibliographyTitle:"参考书目",
      bibliographyIntro:"可用时同步账号，并在此设备备份。",
      styleCompassTitle:"格式指南",
      styleApaUse:"社会科学、教育与商科。",
      styleMlaUse:"文学、语言与艺术。",
      styleChicagoUse:"历史与出版。",
      styleHarvardUse:"适用于多种学科；各校规则不同。",
      styleIeeeUse:"工程与计算机。",
      styleApaAdvice:"APA 7 · 检查句首大小写和斜体。",
      styleMlaAdvice:"MLA 9 · 检查标题大小写。",
      styleChicagoAdvice:"Chicago 17 · 以课程指定版本为准。",
      styleHarvardAdvice:"Harvard · 各校作者—日期规则不同。",
      styleIeeeAdvice:"IEEE · 按加入顺序编号。",
      citationDisclaimer:"提交前，请按课程或出版指南核对每条引用。",
      citationFormattingNote:""
    }),
    "zh-HK": Object.freeze({
      ...
      toolsWorkspaceIntro:"建立格式正確嘅參考文獻、查看文內引用，同埋整理而家項目嘅參考書目。",
      toolsLocalNote:"參考書目會喺可用時同步到你嘅帳戶，並喺呢部裝置備份。搜尋資料來自 Crossref；所選網頁會由 ConCourse 核對。",
      sourceTypeLegend:"來源類型",
      citationEntryModeLegend:"加入此網頁資料",
      citationAutomaticMode:"自動搜尋",
      citationAutomaticModeHint:"貼上網址，或按標題、作者、DOI 或 ISBN 搜尋。",
      citationManualModeHint:"填寫來源資料。",
      ...
      citationLookupNote:"關鍵字搜尋使用 Crossref。請核對匯入欄位。",
      ...
      citationAuthors:"作者或機構",
      citationAuthorsHint:"多位作者用分號分隔；建議使用「姓, 名」。",
      citationTitlePlaceholder:"按照出版資料輸入完整標題",
      ...
      citationClear:"清除欄位",
      citationPreviewEyebrow:"預覽",
      citationPreviewTitle:"參考文獻",
      citationReferenceLabel:"參考文獻",
      citationNoteLabel:"簡短註釋",
      citationPreviewPlaceholder:"輸入標題或貼上參考文獻。",
      citationInlinePlaceholder:"文內引用會顯示喺呢度。",
      citationEditHint:"可以喺呢度修改生成結果。",
      ...
      citationAdd:"儲存到參考書目",
      bibliographyTitle:"參考書目",
      bibliographyIntro:"可用時同步帳戶，並喺呢部裝置備份。",
      ...
      styleCompassTitle:"格式指南",
      styleApaUse:"社會科學、教育同商科。",
      styleMlaUse:"文學、語言同藝術。",
      styleChicagoUse:"歷史同出版。",
      styleHarvardUse:"適用於多種學科；各校規則不同。",
      styleIeeeUse:"工程同電腦。",
      styleApaAdvice:"APA 7 · 檢查句首大小寫同斜體。",
      styleMlaAdvice:"MLA 9 · 檢查標題大小寫。",
      styleChicagoAdvice:"Chicago 17 · 以課程指定版本為準。",
      styleHarvardAdvice:"Harvard · 各校作者—日期規則不同。",
      styleIeeeAdvice:"IEEE · 按加入次序編號。",
      citationDisclaimer:"提交前，請按課程或出版指南核對每條引用。",
      citationFormattingNote:"",
